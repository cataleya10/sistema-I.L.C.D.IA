...
_FIELD_LABELS: dict[str, str] = {
    ...
    "banco": "Nombre del banco (ej. SANTANDER, BBVA, BANORTE)",
    "cuenta": "Número de cuenta bancaria (10-16 dígitos)",
    "titular": "Nombre completo del titular de la cuenta",
    "fecha_corte": "Fecha de corte del estado de cuenta (DD/MM/AAAA)",
    "periodo": "Periodo del estado de cuenta (del DD/MM/AAAA al DD/MM/AAAA)",
